...
do
    time python othello.py --netDelay ${NET_DELAY} \
                           ...
                           --depth ${DEPTH} \
                           --runs ${NUM_RUNS}
    cp out/completion_times.csv data/6-22-19/completion_times/${DEPTH}-level-${nicType}.csv
done
...
time python othello.py --netDelay ${NET_DELAY} \
                       ...
                       --depth ${DEPTH} \
                       --runs ${NUM_RUNS}
cp out/completion_times.csv data/6-22-19/completion_times/${DEPTH}-level-reg-offload.csv
